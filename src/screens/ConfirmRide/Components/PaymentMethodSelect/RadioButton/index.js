...
class RadioButton extends React.Component {
	...
	render() {
        ...
        let { boxStyle, style, circleSize, textStyle, data, icon, deactiveColor, boxActiveBgColor, boxDeactiveBgColor, box, textColor, image } = this.props;
                    ...
                    return (
                        ...
                        >
                            ...
                            <View style={[styles.rightProductBox]}>
                                <Image source={item.image} style={{width : 50, height : 20, resizeMode : 'contain', marginTop : 10}}/>
                            </View>
                        </TouchableOpacity>
                    )
                })
